...
import { Star, ShoppingCart, Plus, Minus, Gift } from "lucide-react";
    ...
    <section className="py-6 sm:py-8 md:py-1">
      <div className="container mx-auto">
        <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-center text-gray-800 flex items-center justify-center">
          <Gift className="w-8 h-8 text-purple-500 mr-2" />
          Top Offers
          <Gift className="w-8 h-8 text-purple-500 ml-2" />
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
          {products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 border-2 border-purple-500"
              ...
              >
                <div className="relative pt-[75%]">
                  ...
                  />
                  <div className="absolute top-0 left-0 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm font-bold px-3 py-1 rounded-br-lg shadow-md">
                    OFFER
                  </div>
                  <div className="absolute bottom-0 right-0 bg-green-400 text-purple-700 text-sm font-bold px-3 py-1 rounded-tl-lg shadow-md">
                    Save {discount}%
                  </div>
                </div>
                <div className="p-4">
                    ...
                    <div className="flex items-center">
                      {quantity === 0 ? (
                        <button
                          ...
                          className="bg-purple-500 text-white px-2 py-1 rounded-full hover:bg-purple-600 transition-colors duration-300 flex items-center"
                        >
                        ...
                        <div className="flex items-center bg-purple-100 rounded-full">
                          <button
                            ...
                            className="text-purple-500 hover:text-purple-600 transition-colors duration-300 p-1"
                          >
                            <Minus size={14} />
                          </button>
