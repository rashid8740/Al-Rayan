        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
          {products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 border-2 border-orange-500"
              ...
              >
                <div className="relative pt-[75%]">
                  ...
                  <div className="absolute bottom-0 right-0 bg-yellow-400 text-orange-700 text-sm font-bold px-3 py-1 rounded-tl-lg shadow-md">
                    -{discount}%
                  </div>
                </div>
                <div className="p-4">
